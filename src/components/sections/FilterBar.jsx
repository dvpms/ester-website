    ...
    <div className="bg-white/95 border-b border-border-c shadow-filter sticky top-[72px] z-40">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
        <div className="flex flex-col lg:flex-row items-stretch lg:items-center gap-3">
          ...
          <div className="flex items-center gap-2 text-sm font-semibold text-remax-blue font-sans shrink-0">
          ...
          {hasActiveFilter && (
            <button
              onClick={onReset}
              className="flex items-center gap-1.5 text-sm text-neutral-600 hover:text-remax-red font-sans transition-colors shrink-0 px-2 py-2.5"
